...
public class _03MyLockCircleSleep {
    ...
    static {
        try {
            unsafe = getUnsafe();
            Field field = _02MyLockCircleYied.User.class.getDeclaredField("age");
    ...
    public static void main(String[] args) throws Exception {
        _03MyLockCircleSleep myLockCircleYied = new _03MyLockCircleSleep();
        _03MyLockCircleSleep.User user = new _03MyLockCircleSleep.User(0);
    ...
    public void thread_1(final _03MyLockCircleSleep.User user) {
        for (int i = 0; i < 20; i++) {
            final int j = i;
...
//                        }
    ...
    public void thread_2(final _03MyLockCircleSleep.User user) {
        for (int i = 0; i < 20; i++) {
            final int j = i;
            new Thread(new Runnable() {
                public void run() {
